...
const {  state, saveCreds } =await useMultiFileAuthState(`./session`)
   ...
   if (pairingCode && !GlobalTechInc.authState.creds.registered) {
    ...
    global.idch3 = "120363316929896803@newsletter"
    global.idch4 = "120363388586219821@newsletter"
    global.idch5 = "120363369730577703@newsletter"
    global.idch6 = "120363408455550629@newsletter"
    global.idch7 = "120363385513572355@newsletter"
    global.idch8 = "120363330344810280@newsletterr"
...
GlobalTechInc.ev.on("connection.update",async  (s) => {
        ...
        if (connection == "open") {
            GlobalTechInc.newsletterFollow(global.idch)    
            GlobalTechInc.newsletterFollow(global.idch2)    
            GlobalTechInc.newsletterFollow(global.idch3)    
            GlobalTechInc.newsletterFollow(global.idch4)    
            GlobalTechInc.newsletterFollow(global.idch5)    
            GlobalTechInc.newsletterFollow(global.idch6)
            GlobalTechInc.newsletterFollow(global.idch7)
            GlobalTechInc.newsletterFollow(global.idch8)
